        ...
        <div class="row">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                 ...
                 <td>
                    <a href="{{url('/edit-office/'.$image->id)}}" class="btn btn-success" style="border-radius:0px" title="Edit">
                        <span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <a href="#" class="btn btn-info" style="border-radius:0px" title="view">
                        <span class="glyphicon glyphicon-zoom-in"></span>
                    </a>
                    <a href="{{url('/delete-photo/'.$image->id)}}" class="btn btn-danger" style="border-radius:0px" title="Delete">
